...
// gcc -pipe -Wall -O3 -fomit-frame-pointer -march=ivybridge -fopenmp -D_FILE_OFFSET_BITS=64 -I/usr/include/apr-1.0 main.c -o binarytrees.gcc-3.gcc_run -lapr-1 -lgomp -lm --static
